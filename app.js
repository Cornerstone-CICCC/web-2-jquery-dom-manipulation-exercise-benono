...
$(function () {
  ...
  $("#exercise2Button").on("click", function () {
    $("#exercise2 p").parent("div").css("background-color", "red");
  });
  ...
  $("#exercise4Button").on("click", function () {
    $(this).siblings("p").first().next().hide();
  });
  ...
  $("#exercise5Button").on("click", function () {
    $(this).siblings("div").children("p").css("border", "1px red solid");
  });
  ...
  $("#exercise6Button").on("click", function () {
    $(this).prev().prev().find("span").css("background-color", "red");
  });
});
